            ...
            switch (logMessageType) {
                ...
                case "log:subscribe": {
                    if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
                        ...
                        try {
                            // Properly call handleCreateDatabase with the required context
                            const handleCreateDB = require('./handleCreateDatabase.js')({ Users, Threads, Currencies });
                            handleCreateDB({ event });
                        } catch(e) {
                            console.log('handleCreateDatabase error:', e);
                        }
                        return;
                    }
                    break;
